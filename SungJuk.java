...
public class SungJuk {
	...
	public static void main(String[] args) {
		// sj는 참조형 변수로 호출하면 주소번지가 출력됨 
		// 언제 사용하지? ==> 클래스 안에 선언된 변수나 메소드를 누릴때 사용함 
		SungJuk sj = new SungJuk();
		int hap = sj.total();
		System.out.println("총점은 "+hap);
		
		double avg = sj.average(hap); //hap = parameter / 내 안에 있다하더라도 static이 있으면 non-static 이 올수 없음 => 인스턴스화 해야함 
		System.out.println("평균은 "+avg);
		// insert here - 굳이 업무담당자가 화면에 과목명을 출력해 달라고 한다. 
		// 어떡하지?
